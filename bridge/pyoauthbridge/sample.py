...
if __name__ == '__main__':
  ...
  client_secret = "wS5fLoQeRuNVJZL9aJ7uSt6uVq0CEv9QwzIUhaEoAGg9WGJYEssRsFE3MzjrviTn"
  redirect_url = "http://127.0.0.1:65010"
  
  websocket_url = ""
  base_url = "https://alpha-staging.sasonline.in"
  conn = Connect(client_id, client_secret, redirect_url, base_url)
  conn.set_access_token('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJibGFja2xpc3Rfa2V5IjoiQVYxMTQ6TWNqS09hdlRIejZIWmRCWjRXYjE1ZyIsImNsaWVudF9pZCI6IkFWMTE0IiwiY2xpZW50X3Rva2VuIjoiVms0bmtMaVdUZ3dGUGVvZCtxL0x3ZyIsImRldmljZSI6IndlYiIsImV4cCI6MTYzOTUwNjY1OTQ0MH0.bsruO0459bVzjXkYBNrj8uv6XMrcTkP2zTzdawkUA5Q')
  ...
  orderupdate_payload = {'client_id': 'AV114'}
  print('proceeed')
