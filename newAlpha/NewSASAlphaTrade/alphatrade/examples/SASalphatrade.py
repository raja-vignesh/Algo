...
class AlphaTrade(object):
    ...
    def __ws_run_forever(self):
        #print('__ws_run_forever')
        while True:
            try:
                self.__websocket.run_forever(sslopt={"cert_reqs": ssl.CERT_NONE})
