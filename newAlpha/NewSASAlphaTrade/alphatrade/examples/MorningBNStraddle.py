...
def open_socket():
    ...
    instruments = [BankNiftyFut_scrip,BankNifty_scrip,vixInstrument]
    ...
    try:    
        while order_placed == False:
              ...
              #write to the vix file
                
              writeToTheFileWithContent('vix.txt',str(vix))
              placeorders()
              order_placed = True
...
def placeStopOrders():
    ...
    tradeActive = True
    watchStraddleStopOrders(sas,orders,tradeActive,'MorningBNStraddle')             
  

if(__name__ == '__main__'):
    logging.debug('09:20 BN Starddle started')
    sendNotifications('09:20 BN Starddle started')
    #while True:
    main()